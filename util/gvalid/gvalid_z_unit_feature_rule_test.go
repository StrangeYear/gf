...
func Test_StringMatchRules(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.AssertNil(g.Validator().Data("goframe").Rules("contains:fra").Run(ctx))
		t.AssertNE(g.Validator().Data("goframe").Rules("contains:xyz").Run(ctx), nil)
	})
	gtest.C(t, func(t *gtest.T) {
		t.AssertNil(g.Validator().Data([]string{"go", "frame"}).Rules("contains:frame").Run(ctx))
		t.AssertNE(g.Validator().Data([]string{"goframe"}).Rules("contains:fra").Run(ctx), nil)
	})
	gtest.C(t, func(t *gtest.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		t.AssertNil(g.Validator().Data("goframe").Rules("excludes:xyz").Run(ctx))
		t.AssertNE(g.Validator().Data("goframe").Rules("excludes:fra").Run(ctx), nil)
	})
	gtest.C(t, func(t *gtest.T) {
		t.AssertNil(g.Validator().Data([]string{"go", "frame"}).Rules("excludes:fra").Run(ctx))
		t.AssertNE(g.Validator().Data([]string{"go", "frame"}).Rules("excludes:frame").Run(ctx), nil)
	})
	gtest.C(t, func(t *gtest.T) {
